        ...
        children: [
                  ...
                  children: [
                    Text("${providerFalse!.gameinfo[index].name}",
                        style: TextStyle(
                            ...
                            fontSize: 20)),
                    Text("${providerFalse!.gameinfo[index].company}",
                        style: TextStyle(
                            color: Colors.green,
                            letterSpacing: 1,
                            fontFamily: 'robo',
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    Text(
                      "${providerFalse!.gameinfo[index].size}",
                      style: TextStyle(
                          color: Colors.black,
                          fontFamily: 'robo',
                          fontSize: 12,
                ...
                Column(
                  children: [
                    Text(
                      "${providerFalse!.gameinfo[index].download}",
                      style: TextStyle(
                          color: Colors.black,
                          fontFamily: 'robo',
                          fontSize: 13,
              ...
              itemBuilder: (context, i) {
                return Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.asset(
                      "${providerFalse!.gameinfo[index].image![i]}",
                      fit: BoxFit.cover,
                    ),
                  ),
                );
          ...
          Padding(
            ...
            child: Container(
              ...
              child: Text(
                "${providerFalse!.gameinfo[index].about}",
                style: TextStyle(
                    letterSpacing: 1,
                    fontSize: 15,
                    fontFamily: 'robo',
