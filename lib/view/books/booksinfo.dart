...
class BooksInfo extends StatefulWidget {
  const BooksInfo({Key? key}) : super(key: key);
    ...
    return SafeArea(
      ...
      body: Column(
        ...
        children: [
              ...
              children: [
                ...
                Center(
                  child: Container(
                    ...
                    child: Center(
                      child: Text(
                        "Ebook ₹${providerFalse!.book[index].rate}",
                        style: TextStyle(
                            letterSpacing: 1,
                            fontFamily: 'robo',
                            fontSize: 15,
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 10),
            child: Text("Build a series bundle",style: TextStyle(color: Colors.black,letterSpacing: 1,fontFamily: 'robo',fontSize: 20),),
          ),
          SizedBox(height: 30),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 10),
